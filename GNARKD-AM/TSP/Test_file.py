...
# This file is used to test the performance of GNARKD-AM for TSP
...
# test dataset
x_10k = torch.load('../../Test_data/TSP/10k_TSP50.pt').to(device) if args.problem_size == 50 else torch.load('../../Test_data/TSP/10k_TSP100.pt').to(device)
